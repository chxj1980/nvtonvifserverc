...
SOAP_FMAC5 int SOAP_FMAC6 __wsdd__Probe(struct soap* soap,
	...
	/*×¢ÊÍµÄ²¿·ÖÎª¿ÉÑ¡£¬×¢ÊÍµôonvif testÒ²ÄÜ·¢ÏÖws-d*/
	...
	/* send over current socket as HTTP OK response: */
	 /*²âÊÔ¹ý£¬µÚ¶þ²ÎÊý±ØÐëhttp£¬actionËæÒâ*/
